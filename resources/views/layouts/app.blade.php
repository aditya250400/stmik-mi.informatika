...
<head>
  ...
  <link href="{{ secure_asset('/css/ukm.css') }}" rel="stylesheet">
  <link href="{{ secure_asset('/css/matkul.css') }}" rel="stylesheet">
...
<body class="@yield('profile')">
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto"><img src="{{ secure_asset('/img/MI2.jpg') }}" align="left"><a href="/">STMIK Mardira<br>Indonesia</a></h1>
        ...
        <ul>
          ...
          @guest
            ...
            @else
             ...
             <li class="dropdown"><a href="{{ route('mahasiswa.show', ['mahasiswa' => Auth::user()->id]) }}"><span><img class="rounded-circle z-depth-2 img-thumbnail img-nav" src="{{ secure_asset('/img/user/'.Auth::user()->gambar_profil) }}"></span> <i class="bi bi-chevron-down"></a></i>
               <ul>
...
<br><br><br><br>
  ...
  <script type="text/javascript" src="{{ secure_asset('/js/gambarProfil.js') }}"></script>
